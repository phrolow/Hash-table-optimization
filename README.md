...
Результат работы профайлера - **data/callgrind.out.87982**
...
Теперь узкое место - хеш-функция. Я могу переписать её с использованием SIMD-овской хеш-функции **_mm_crc32_u32**.
 ### Использование SIMD
