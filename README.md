...
Доброго дня всем читающим! В этом проекте я попытался исследовать возможности оптимизации времени поиска в хеш-таблицах. Таким образом, моя работа не ставит целью оптимизировать время заполнения хещ-таблицы и удаления элементов из неё или же сократить расход памяти - я хочу понять цену максимальной оптимизации по времени.
## О хеш-таблицах
...
Заново измерив время поиска при размере хеш-таблицы в **317** элементов, я получил время поиска **3,649 мс**; установив размер в **4973** элемента, я получил **2,064 мс**. Относительные приросты всех оптимизаций для наглядности я приведу в выводе.
 ### Флаги компиляции
