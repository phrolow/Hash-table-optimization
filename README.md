...
Функция показала лучшее распределение среди всех представленных функций; тем не менее, по времени поиска (**6,677 мс**) такая хеш-таблица проигрывает предыдущим двум. 