...
Сначала я попробовал заменить код **simdCrc32** ассемблерным кодом **_simdCrc32**. И хотя это позволило мне убрать флаг **-no-pie**, время работы увеличилось аж до **3.399 мс**
