...
Чтобы написать новую вставку, мне пришлось немного изучить синтаксис ключевого слова **asm**. С использованием во вставке входных и выходных данных, а также переделыванием функции в **inline** (что потребовало переписывать некоторые участки кода и, в частности, убрать ссылку на функцию из структуры хеш-таблицы, что сокращает универсальность) я смог добиться времени выполнения в **454 мс**. Прогон через **callgrind** лежит в **callgrind.out.12561**
